...
const friendsData = [
    { name: 'Alice', imageUrl: '/player1.png' },
    { name: 'Bob', imageUrl: '/player2.png' },
    { name: 'Charlie', imageUrl: '/player3.png' },
    { name: 'Diana', imageUrl: '/player4.png' },
    { name: 'Emma', imageUrl: '/player5.png' },
    { name: 'Frank', imageUrl: '/player6.png' },
    { name: 'Alice', imageUrl: '/player1.png' },
    { name: 'Bob', imageUrl: '/player2.png' },
    { name: 'Charlie', imageUrl: '/player3.png' },
    { name: 'Diana', imageUrl: '/player4.png' },
