    ...
    return (
        <div className="h-screen w-full flex-col flex gap-4 items-center justify-center bg-root-background bg-cover bg-center bg-no-repeat text-white space-y-4">
            ...
            <div className='flex flex-col items-center justify-center'>
                <h3 className='lg:text-7xl sm:text-4xl text-xl border-b-2 pb-4 uppercase'>{t("we can't find this page")}</h3>
                <p className='uppercase md:text-[30rem] sm:text-[15rem] text-[8rem] leading-[1] font-bold'>404</p>
                <h3 className='md:text-7xl sm:text-4xl text-xl border-t-2 pt-4 uppercase'>{t("page lost")}</h3>
            </div>
